            ...
            <div class="w-full px-6">
                <div class="flex flex-col rounded-xl bg-outer-space-100 p-6 shadow-xl">
                    ...
                    <div class="flex items-center justify-end gap-x-6">
                        <button class="mt-6 text-base/normal font-semibold text-outer-space-900 cursor-pointer transition-colors duration-200 hover:text-outer-space-700 active:text-outer-space-950" {...$itemDialogClose} use:itemDialogClose>Cancel</button>

                        <button class="mt-6 text-base/normal font-semibold text-outer-space-900 cursor-pointer transition-colors duration-200 hover:text-outer-space-700 active:text-outer-space-950" on:click|stopPropagation={handleDeletion}>Remove</button>
                    </div>
                </div>
            </div>
        </div>

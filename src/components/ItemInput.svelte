    ...
    <div class="container mx-auto px-6">
        <div class="flex flex-col justify-center my-6 relative">
            <div class="flex w-full items-center justify-between gap-x-6">
                ...
                {#if !showInput}
                    <ScreenshotButton class="flex items-center justify-center rounded-full bg-old-gold-500 p-4 transition-transform duration-200 ease-[cubic-bezier(0.4,0,0.2,1)]" targetSelector="#capture-target">

...
<header class="bg-transparent py-3">
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-[auto_auto_1fr] items-center gap-x-6">
            ...
            <div class="justify-self-end relative flex items-center">
                ...
                {#if autoToggleEnabled}
                <div class="-top-3 left-5 absolute">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4 fill-old-gold-600" viewBox="0 0 16 16">
